...
**TKTK: Describe history-of-jobs here.**
...
```
cd history-of-jobs
mkvirtualenv --no-site-packages history-of-jobs
...
```
* * * * * ubuntu bash /home/ubuntu/apps/history_of_jobs/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|history-of-jobs|tweet|`location`||||
|history-of-jobs|facebook|`location`||||
|history-of-jobs|email|`location`||||
|history-of-jobs|new-comment||||
|history-of-jobs|open-share-discuss||||
|history-of-jobs|close-share-discuss||||
|history-of-jobs|summary-copied||||
|history-of-jobs|featured-tweet-action|`action`||``tweet_url``|
|history-of-jobs|featured-facebook-action|`action`||``post_url``|
